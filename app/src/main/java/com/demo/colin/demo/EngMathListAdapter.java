...
public class EngMathListAdapter extends BaseAdapter {
    ...
    // constructor 函数
    public EngMathListAdapter(ArrayList<String> contextList, Context context, HashMap<Integer,Boolean>selectedMap){
